...
void histoMatchExactExtra(ImagePtr, ImagePtr, ImagePtr);
...
void histoMatchExactExtra(ImagePtr I1, ImagePtr targetHisto, ImagePtr I2){
	...
	IP_copyImageHeader(I1, I2);
        ...
        // use IP_embedRange to scale the range
